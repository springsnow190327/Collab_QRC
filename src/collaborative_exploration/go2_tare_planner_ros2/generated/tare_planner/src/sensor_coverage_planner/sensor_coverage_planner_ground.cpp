...
bool SensorCoveragePlanner3D::initialize(ros::NodeHandle& nh, ros::NodeHandle& nh_p)
{
  ...
  {
    RCLCPP_ERROR(rclcpp::get_logger("tare_ros2_exact"), "Read parameters failed");
    return false;
  }
...
void SensorCoveragePlanner3D::execute(const ros::TimerEvent&)
{
  ...
  {
    RCLCPP_INFO(rclcpp::get_logger("tare_ros2_exact"), "Waiting for start signal");
    return;
  }
  ...
  if (keypose_cloud_update_)
  {
    ...
    {
      RCLCPP_WARN(rclcpp::get_logger("tare_ros2_exact"), "Cannot get candidate viewpoints, skipping this round");
      return;
    }
