...
Deprecated: use `dual_go2_modular.launch.py profile:=autonomy`.
"""
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            LogInfo(msg="[DEPRECATED] two_go2_t_world_autonomy.launch.py -> dual_go2_modular.launch.py profile:=autonomy"),
