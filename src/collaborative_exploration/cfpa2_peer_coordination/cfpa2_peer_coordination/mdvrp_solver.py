...
This file is vendored from the previous cfpa2_collaborative_autonomy.mdvrp_solver
because the upstream package no longer exposes the solver. Keeping it inside
cfpa2_peer_coordination makes the decentralised package self-contained.
"""
