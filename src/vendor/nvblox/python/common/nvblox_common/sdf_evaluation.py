...
def get_sdf_abs_error_grid(reconstructed_sdf: VoxelGrid, gt_sdf: VoxelGrid) -> VoxelGrid:
    ...
    Note that we only compute the difference at locations where the ground-truth ESDF is
       positive. (This means that this function is not symmetric in its input),
