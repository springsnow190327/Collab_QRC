...
def get_error_mesh(reconstructed_mesh: o3d.geometry.TriangleMesh,
                   errors: np.ndarray) -> o3d.geometry.PointCloud:
    """
    Create a error mesh, which is a copy of the reconstruction colored by error.
...
def get_per_vertex_coverage(reconstructed_mesh: o3d.geometry.TriangleMesh,
    ...
    We a define a covered vertex in the groundtruth mesh as having a reconstructed mesh vertex
