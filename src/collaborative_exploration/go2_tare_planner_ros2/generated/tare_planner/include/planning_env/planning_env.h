...
public:
  ...
  void UpdateRegisteredCloud(typename pcl::PointCloud<PCLPointType>::Ptr& cloud)
  {
    ...
    {
      RCLCPP_WARN(rclcpp::get_logger("tare_ros2_exact"), "PlanningEnv::UpdateRegisteredCloud(): registered cloud empty");
      return;
    }
    else
    {
  ...
  void UpdateKeyposeCloud(typename pcl::PointCloud<PCLPointType>::Ptr& keypose_cloud)
  {
    ...
    {
      RCLCPP_WARN(rclcpp::get_logger("tare_ros2_exact"), "PlanningEnv::UpdateKeyposeCloud(): keypose cloud empty");
      return;
    }
    else
    {
